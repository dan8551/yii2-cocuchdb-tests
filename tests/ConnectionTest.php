...
use yii\couchdb\Collection;
use yii\couchdb\Command;
use yii\couchdb\file\Collection as FileCollection;
use yii\couchdb\Connection;
use yii\couchdb\Database;
use yii\couchdb\QueryBuilder;
...
class ConnectionTest extends TestCase
{
    ...
    public function testOpenClose()
    {
        ...
        $this->expectException('yii\couchdb\Exception');
        $connection->open();
    }
    ...
    public function dataProviderFetchDefaultDatabaseName()
    {
        return [
            [
                'couchdb://travis:test@localhost:27017/dbname',
                'dbname',
            ],
            [
                'couchdb://travis:test@localhost:27017/dbname?replicaSet=test&connectTimeoutMS=300000',
                'dbname',
            ],
        ];
    }
    ...
    {
        $connection = new Connection();
        $connection->dsn = $this->couchDBConfig['dsn'];
